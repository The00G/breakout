...
public class Brick extends Obstacle {
     ...
     * <ul>
     * <li>the color in position 0 is the color for indestructible bricks
     * <li>the colors in position 1 to 7 are the colors for the corresponding life
     * level
     * <li>the color in position 8 is the color for bricks with a life level of 8 or
     * more
     * </ul>
     */
    ...
    /**
     * Decreases the life of this brick by one and updates the color according to
     * its new life
     */
    @Override
    public int hit() {
